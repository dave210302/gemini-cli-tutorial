...
class NotepadWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Load and apply theme before initUI
    ...
    def initUI(self):
        ...
        self.set_theme(self.current_theme) # Apply theme after all UI elements are created
    ...
    def create_actions(self):
        ...
        # Ensure only one theme is checked at a time
    ...
    def set_theme(self, theme):
        ...
        # Update check state of theme actions
